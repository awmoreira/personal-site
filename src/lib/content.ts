...
export const content: Record<Locale, Copy> = {
  en: {
    ...
    headline: "I build software people can rely on.",
    intro:
    ...
    photoCaption: "SOFTWARE · SYSTEMS · PEOPLE",
  ...
  pt: {
    ...
    eyebrow: "SENIOR SOFTWARE ENGINEER · TECH LEAD & ARCHITECT",
    headline: "Construo software em que as pessoas podem confiar.",
    intro:
    ...
    photoCaption: "SOFTWARE · SISTEMAS · PESSOAS",
